...
const SortableCard = ({ card, client, tags, users, onEdit, onUpdateCard, viewMode }: { key?: string | number, card: OperationCard, client?: Client, tags: Tag[], users: UserProfile[], onEdit: (card: OperationCard) => void, onUpdateCard: (cardId: string, data: Partial<OperationCard>) => Promise<void>, viewMode: 'kanban' | 'list' | 'vertical' }) => {
  const {
    attributes,
    listeners,
    setNodeRef,
...
export const OperationView: React.FC<OperationViewProps> = ({ viewMode, companyId, lists, cards, clients, tags, users, onMoveToSector }) => {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <CompletedCardsModal 
        ...
        title="Cards Concluídos - Operação"
      />
    </div>
  );
};
