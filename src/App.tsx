  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-stone-900 flex items-center justify-center p-6 font-nunito">
        <div className="max-w-md w-full bg-stone-800 p-8 rounded-3xl shadow-xl border border-stone-700 text-center">
          <div className="w-16 h-16 bg-stone-900/50 rounded-2xl flex items-center justify-center mx-auto mb-6">
            <Briefcase size={32} className="text-white" />
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">CRM Talí</h1>
          <p className="text-stone-200 mb-8">Faça login para gerenciar seus projetos.</p>
          
          <form onSubmit={handleEmailAuth} className="space-y-4 mb-6 text-left">
            {authError && (
              <div className="bg-red-500/20 text-white p-3 rounded-xl text-sm text-center border border-red-500/50">
                {authError}
              </div>
            )}
            
            <div className="space-y-1">
              <label className="text-xs font-bold uppercase tracking-widest text-stone-200 ml-1">Email</label>
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-stone-900 border border-stone-700 rounded-xl pl-10 pr-4 py-3 text-sm text-white focus:outline-none focus:ring-2 focus:ring-white/20 placeholder:text-stone-500"
            ...
            <div className="space-y-1">
              <label className="text-xs font-bold uppercase tracking-widest text-stone-200 ml-1">Senha</label>
              <div className="relative">
            ...
            <button 
              ...
              className="w-full bg-white text-stone-900 py-3.5 rounded-xl hover:bg-stone-100 transition-all font-bold disabled:opacity-50"
            >
          ...
          <div className="relative flex items-center py-2 mb-6">
            ...
            <span className="flex-shrink-0 mx-4 text-stone-300 text-xs uppercase tracking-widest font-bold">Ou</span>
            <div className="flex-grow border-t border-stone-700"></div>
          </div>
          ...
          <button 
            ...
            type="button"
            className="w-full flex items-center justify-center space-x-3 bg-stone-900 border border-stone-700 text-white py-3.5 rounded-xl hover:bg-stone-950 transition-all font-bold mb-6"
          >
            ...
            <span>Entrar com Google (Recuperado)</span>
          </button>
